...
# Here we also reproduce Figure 3 and Supp. Figures 3 and 4.
...
# Whole multi-omics network (Supp. Fig. 3) ####
...
# AA - Fos/Jun - Egr community subnetwork (Fig. 3 - Right) ####
...
# Cirbp neighborhood subnetwork  (Fig. 3 - Left) ####
...
# Supplementary network with community highlighted (Supp. Fig. 4) ####
igraph::V(sel_igraph)$frame.width<-2
igraph::V(sel_igraph)$label<-NA
igraph::V(sel_igraph)$size<-node.size*0.40
igraph::E(sel_igraph)$width<-0.3
